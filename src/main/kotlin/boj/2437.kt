...
boj.getArr[i] : i 를 만드는데 필요한 것들 ( 리스트 )

1 2 3

1 가능 / boj.getArr[1] = [1]
2 가능 / boj.getArr[2] = [2]
3 가능 / boj.getArr[3] = [boj.getArr[2] + 1], [3]
4 가능 / boj.getArr[4] = boj.getArr[3] + [1], boj.getArr[2] + [2], boj.getArr[1] + 2, boj.getArr[0] + 4

4가 가능한지 체크한다는 것은 1,2,3 이 된다는 것이고 boj.getArr[1] boj.getArr[2] boj.getArr[3] 이 있다는 거고....
...
그니까
정렬해서 sum 을 구하는데 sum + 1 < boj.getArr[i] 인 경우 sum + 1 을 만들 수 없음
*/
